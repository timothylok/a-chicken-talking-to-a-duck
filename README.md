...
- **ASR** — FastAPI + faster-whisper `medium` on a 4 GB GTX 1650, running as a Windows service. A Whisper `initial_prompt` built from the command vocabulary biases decoding toward the exact allowlisted phrases.
