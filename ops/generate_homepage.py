...
AUTOMATIONS = [
    ...
    ("朝早9點05分", "監察PriceSpy價錢——Nintendo Switch 2、Corsair Vengeance LPX White DDR4記憶體、Kingston Fury Beast Black DDR4記憶體、G.Skill Ripjaws V Black DDR4記憶體、Pokemon Pokopia (Switch 2)、Zelda: Tears of the Kingdom (Switch 2)——如果今日平過上次記錄就推送通知去手機"),
